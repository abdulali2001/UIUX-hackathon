    ...
    return (
       <div className="bg-[#fdf7f1] py-12">
          <div className="flex items-center gap-8">
            {/* Left Content */}
            <div className="text-left pl-[100px] pr-[42pxx] flex flex-col gap-[25px]">
            ...
            <div className="w-full md:flex hidden items-center justify-center gap-8">
               ...
               <div className="flex flex-col justify-between h-[582px]">
                 ...
                 <div className="flex gap-[20px] items-center mb-[30px]">
                   <span className="w-[27px] rounded-full border border-primary cursor-pointer bg-transparent flex-transparent flex justify-center items-center">
