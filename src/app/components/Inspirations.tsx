      ...
      <div className="flex items-center gap-8">
        ...
        <div className="text-left pl-[100px] pr-[42px] flex flex-col gap-[25px]">
          <div className="flex flex-col gap-2">
            <h2 className="text-[40px] font-bold  text-Gray-1 leading-[42px]">
              50+ Beautiful rooms inspiration
            </h2>
            <p className="text-[16px] font-medium text-Gray-2">
              Our designer already made a lot of beautiful prototype of rooms
              that inspire you.
            </p>
          </div>
          <button className="bg-primary bg-[#B88E2F] px-[36px] py-[12px] font-semibold text-[16px] w-fit hover:bg-[#374151] transtion duration-300">
            Explore More
          </button>
        </div>
